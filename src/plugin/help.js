...
╰─────────────━┈⊷ `
            ...
            footer: proto.Message.InteractiveMessage.Footer.create({
              text: "𝐁𝐎𝐓 𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 𝗠𝗘𝗡𝗧𝗢𝗥 𝗞𝗘𝗩𝗜𝗡\n\n© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝔪𝔢𝔫𝔱𝔬𝔯 𝔨𝔢𝔳𝔦𝔫🕑"
            }),
        ...
        },
        {
         name: 'cta_url',
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://youtube.com/@mentor_kevin?si=jJATFZS9YrD5bAvg',
          })
        },
                {
                  "name": "single_select",
                  "buttonParamsJson": `{"title":"🙂‍↕️Open 𝗠-𝗞 𝗕𝗢𝗧 Menu🙂‍↕️",
                 "sections":
                   [{
                    "title":"😎 𝗠-𝗞 𝗕𝗢𝗧 𝐀𝐋𝐋 𝐌𝐄𝐍𝐔",
                    "highlight_label":"🤩ALL MENU",
                    "rows":[
                      {
                       "header":"",
                       "title":"🔰 ᴀʟʟ ᴍᴇɴᴜ",
                       "description":"𝗠-𝗞 𝗕𝗢𝗧 𝐀𝐋𝐋 𝐌𝐄𝐍𝐔",
                       "id":"View All Menu"
                      },
                      {
                        "header":"",
...
╰━━━━━━━━━━━━━━━⪼`
await Matrix.sendMessage(m.from, {
  image: fs.readFileSync('./src/watermark.png'), 
  caption: str, 
  contextInfo: {
                  mentionedJid: [m.sender], 
                  forwardingScore: 999,
